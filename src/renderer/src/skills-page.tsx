...
const AGENT_LOGOS = {
  ...
  codex: (
    <svg
      ...
      fillRule="evenodd"
    >
      <linearGradient id="codex-logo-gradient" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0" stopColor="#c8abff" />
        <stop offset="0.4" stopColor="#8f8aff" />
        <stop offset="0.7" stopColor="#5c86ff" />
        <stop offset="1" stopColor="#2424ff" />
      </linearGradient>
      <path
        clipRule="evenodd"
